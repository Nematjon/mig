...
<html lang="<?= Yii::$app->language ?>"  id="extr-page">
	...
	<video class="video" loop="true" autoplay="true" poster="<?=Yii::getAlias('@web');?>/images/backMain.png">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Нужна учетная запись?</span> <a href="<?=Yii::getAlias('@web');?>/agent/login" class="btn btn-danger">Регистрация</a> </span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
					 	...
					 	<?php $form = ActiveForm::begin(['id' => 'login-form','class'=>'smart-form client-form']); ?>
				 			...
				 			<section>
								...
								<label class="input"> 
									...
									<i class="fa fa-user txt-color-teal"></i> Пожалуйста имя пользователя</b></label>
							</section>
			            ...
			            <?php ActiveForm::end(); ?>
							...
							<form action="<?=Yii::getAlias('@web');?>/agent/index" method="post" id="login-form" class="smart-form client-form">
								<header>
									Войти в систему
								</header>
								...
								<fieldset>
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-user"></i>
											...
											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Пожалуйста имя пользователя</b></label>
									</section>
